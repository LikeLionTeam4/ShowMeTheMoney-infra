...
|---|---|---|
| `smtm-backend` | `<AWS_ACCOUNT_ID>.dkr.ecr.ap-northeast-2.amazonaws.com/smtm-backend:<TAG>` | Spring Backend |
| `smtm-frontend` | `<AWS_ACCOUNT_ID>.dkr.ecr.ap-northeast-2.amazonaws.com/smtm-frontend:<TAG>` | Next.js Frontend |
...
| IP Type | IPv4 |
| Target Type | IP |
| Public Subnet A | `<PUBLIC_SUBNET_A_ID>` |
| Public Subnet B | `<PUBLIC_SUBNET_B_ID>` |
