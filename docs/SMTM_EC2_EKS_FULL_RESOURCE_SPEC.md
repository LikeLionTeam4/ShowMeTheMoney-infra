...
| Subnet | ID |
|---|---|
| `team4-public-a` | `<PUBLIC_SUBNET_A_ID>` |
| `smtm-public-b` | `<PUBLIC_SUBNET_B_ID>` |
...
| Repository | URI | 용도 |
|---|---|---|
| `smtm-backend` | `<AWS_ACCOUNT_ID>.dkr.ecr.ap-northeast-2.amazonaws.com/smtm-backend` | Spring Backend Image |
| `smtm-frontend` | `<AWS_ACCOUNT_ID>.dkr.ecr.ap-northeast-2.amazonaws.com/smtm-frontend` | Next.js Frontend Image |
